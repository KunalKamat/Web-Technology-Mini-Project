...
<div class="parent-container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        // Retrieve booking number from the form
        $bookingNumber = $_POST["booking_number"];

        // Add your logic to manage the booking here

        // For now, let's just display the booking number
        echo "<div class='container'>";
        echo "<h2>Booking Management</h2>";
        echo "<p>Booking Number: $bookingNumber</p>";
        echo "</div>";
    }
    ?>
    <div class="buttons">
